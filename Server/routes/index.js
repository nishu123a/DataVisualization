...
import { getAllTopics } from '../controllers/main.js';
import { getCountries } from '../controllers/main.js';
import { getAllRelevances } from '../controllers/main.js';
import { getDataByIntensity } from '../controllers/main.js';
import { getAllLikelihoods } from '../controllers/main.js';
//creating a router
...
router.get('/relevances', getAllRelevances);
router.get('/intensity',getDataByIntensity)
router.get('/likelihoods',getAllLikelihoods)
